        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisteredTo = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutedOrCancelledAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ManagerNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ApprovedOrCancelledAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    AppointmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GlossaryDictionaryCode = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LaboratoryExaminations", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LaboratoryExaminations_GlossaryDictionaries_GlossaryDictionaryCode",
                        column: x => x.GlossaryDictionaryCode,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PhysicalExaminations_GlossaryDictionaries_GlossaryDictionaryCode",
                        column: x => x.GlossaryDictionaryCode,
                        principalTable: "GlossaryDictionaries",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LaboratoryExaminations_GlossaryDictionaryCode",
                table: "LaboratoryExaminations",
                column: "GlossaryDictionaryCode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhysicalExaminations_GlossaryDictionaryCode",
                table: "PhysicalExaminations",
                column: "GlossaryDictionaryCode");
        }
